...
export  default class ImportSchedulesView extends Component {
    constructor(props){
      super(props);
...
class CreateNewScheduledImport extends Component{
  ...
  render(){
      ...
      return(
        <div style={styles.createNewTaskContainer}>
               <div style={styles.createNewTaskTitle}>Schedule a new task</div>
               <div className="row">
                   ...
                   <label htmlFor="channelId">Channel:</label>
                      <select className="form-control" id="channelId" name="channelId"
                        value={this.state.channelId} onChange={evt=>{this.setChannelId(evt.target.value)}}>
                              <option value="1865244993">On Demand</option>
                      </select>
